...
if(NOT DEFINED CMAKE_CXX_FLAGS)
  ...
  set(CMAKE_EXE_LINKER_FLAGS    "-lpthread -lrt -ldl" CACHE INTERNAL "wyg added for mips cross build error")
  ...
  if(CMAKE_SYSTEM_PROCESSOR STREQUAL mips)
    ##set(MIPS_LINKER_FLAGS "-Wl,--fix-cortex-a8 -Wl,--no-undefined -Wl,--gc-sections -Wl,-z,noexecstack -Wl,-z,relro -Wl,-z,now")
  elseif(CMAKE_SYSTEM_PROCESSOR STREQUAL aarch64)
    ##set(MIPS_LINKER_FLAGS "-Wl,--no-undefined -Wl,--gc-sections -Wl,-z,noexecstack -Wl,-z,relro -Wl,-z,now")
  endif()
...
set(CMAKE_CXX_FLAGS           "${CMAKE_CXX_FLAGS} -O3 -mmsa -mhard-float -mfp64 -mnan=2008")
set(CMAKE_C_FLAGS             "${CMAKE_C_FLAGS} -O3 -mmsa -mhard-float -mfp64 -mnan=2008")
