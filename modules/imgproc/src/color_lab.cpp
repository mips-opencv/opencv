...
#elif CV_MSA
template<typename _Tp> static inline void splineInterpolate(v4f32& v_x, const _Tp* tab, int n)
{
    v4i32 v_ix = msa_cvttruncq_s32_f32(msa_minq_f32(msa_maxq_f32(v_x, msa_dupq_n_f32(0.0f)), msa_dupq_n_f32(n - 1)));
    v_x = msa_subq_f32(v_x, msa_cvtfintq_f32_s32(v_ix));
    v_ix = msa_shlq_n_s32(v_ix, 2);

    int CV_DECL_ALIGNED(16) ix[4];
    msa_st1q_s32(ix, v_ix);

    v4f32 v_tab0 = msa_ld1q_f32(tab + ix[0]);
    v4f32 v_tab1 = msa_ld1q_f32(tab + ix[1]);
    v4f32 v_tab2 = msa_ld1q_f32(tab + ix[2]);
    v4f32 v_tab3 = msa_ld1q_f32(tab + ix[3]);

    v4f32 v00 = (v4f32)msa_ilvrq_s32((v4i32)v_tab1, (v4i32)v_tab0);
    v4f32 v01 = (v4f32)msa_ilvlq_s32((v4i32)v_tab1, (v4i32)v_tab0);
    v4f32 v10 = (v4f32)msa_ilvrq_s32((v4i32)v_tab3, (v4i32)v_tab2);
    v4f32 v11 = (v4f32)msa_ilvlq_s32((v4i32)v_tab3, (v4i32)v_tab2);

    v_tab0 = (v4f32)msa_ilvrq_s64((v2i64)v10, (v2i64)v00);
    v_tab1 = (v4f32)msa_ilvlq_s64((v2i64)v10, (v2i64)v00);
    v_tab2 = (v4f32)msa_ilvrq_s64((v2i64)v11, (v2i64)v01);
    v_tab3 = (v4f32)msa_ilvlq_s64((v2i64)v11, (v2i64)v01);

    v_x = msa_mlaq_f32(v_tab0, msa_mlaq_f32(v_tab1, msa_mlaq_f32(v_tab2, v_tab3, v_x), v_x), v_x);
}
#elif CV_SSE2
...
struct RGB2XYZ_f<float>
{
    ...
    RGB2XYZ_f(int _srccn, int blueIdx, const float* _coeffs) : srccn(_srccn)
    {
        ...
        v_c0 = msa_dupq_n_f32(coeffs[0]);
        v_c1 = msa_dupq_n_f32(coeffs[1]);
        v_c2 = msa_dupq_n_f32(coeffs[2]);
        v_c3 = msa_dupq_n_f32(coeffs[3]);
        v_c4 = msa_dupq_n_f32(coeffs[4]);
        v_c5 = msa_dupq_n_f32(coeffs[5]);
        v_c6 = msa_dupq_n_f32(coeffs[6]);
        v_c7 = msa_dupq_n_f32(coeffs[7]);
        v_c8 = msa_dupq_n_f32(coeffs[8]);
    }
    ...
    void operator()(const float* src, float* dst, int n) const
    {
        ...
        for( ; i <= n - 12; i += 12, src += 4 * scn )
        {
            v4f32 v_src[4];

            if( scn == 3 )
                msa_ld3q_f32(src, &v_src[0], &v_src[1], &v_src[2]);
            else
                msa_ld4q_f32(src, &v_src[0], &v_src[1], &v_src[2], &v_src[3]);

            v4f32 v_dst0 = msa_mlaq_f32(msa_mlaq_f32(msa_mulq_f32(v_src[0], v_c0), v_src[1], v_c1), v_src[2], v_c2);
            v4f32 v_dst1 = msa_mlaq_f32(msa_mlaq_f32(msa_mulq_f32(v_src[0], v_c3), v_src[1], v_c4), v_src[2], v_c5);
            v4f32 v_dst2 = msa_mlaq_f32(msa_mlaq_f32(msa_mulq_f32(v_src[0], v_c6), v_src[1], v_c7), v_src[2], v_c8);

            msa_st3q_f32(dst + i, v_dst0, v_dst1, v_dst2);
        }
    ...
    int srccn;
    float coeffs[9];
    v4f32 v_c0, v_c1, v_c2, v_c3, v_c4, v_c5, v_c6, v_c7, v_c8;
};
...
struct RGB2XYZ_i<uchar>
{
    ...
    RGB2XYZ_i(int _srccn, int blueIdx, const float* _coeffs) : srccn(_srccn)
    {
        ...
        v_c0 = msa_dupq_n_s32(coeffs[0]);
        v_c1 = msa_dupq_n_s32(coeffs[1]);
        v_c2 = msa_dupq_n_s32(coeffs[2]);
        v_c3 = msa_dupq_n_s32(coeffs[3]);
        v_c4 = msa_dupq_n_s32(coeffs[4]);
        v_c5 = msa_dupq_n_s32(coeffs[5]);
        v_c6 = msa_dupq_n_s32(coeffs[6]);
        v_c7 = msa_dupq_n_s32(coeffs[7]);
        v_c8 = msa_dupq_n_s32(coeffs[8]);
        v_delta = msa_dupq_n_s32(1 << (xyz_shift - 1));
    }
    void operator()(const uchar * src, uchar * dst, int n) const
    {
        int scn = srccn, i = 0;
        ...
        {
            v16u8 v_data[4], data0_lo, data0_hi, data1_lo, data1_hi, data2_lo, data2_hi;
            v8u16 zip0_lo, zip0_hi, zip1_lo, zip1_hi, zip2_lo, zip2_hi;

            if( scn == 3 )
                msa_ld3q_u8(src, &v_data[0], &v_data[1], &v_data[2]);
            else
                msa_ld4q_u8(src, &v_data[0], &v_data[1], &v_data[2], &v_data[3]);

            ILVRL_B2_UB(v_data[0], msa_dupq_n_u8(0), data0_lo, data0_hi);
            ILVRL_B2_UB(v_data[1], msa_dupq_n_u8(0), data1_lo, data1_hi);
            ILVRL_B2_UB(v_data[2], msa_dupq_n_u8(0), data2_lo, data2_hi);

            v8u16 v_zip = msa_paddlq_u8(data0_lo);
            ILVRL_H2_UH(v_zip, msa_dupq_n_u16(0), zip0_lo, zip0_hi);
            v_zip = msa_paddlq_u8(data1_lo);
            ILVRL_H2_UH(v_zip, msa_dupq_n_u16(0), zip1_lo, zip1_hi);
            v_zip = msa_paddlq_u8(data2_lo);
            ILVRL_H2_UH(v_zip, msa_dupq_n_u16(0), zip2_lo, zip2_hi);

            v4i32 src0_lo = (v4i32)msa_paddlq_u16(zip0_lo);
            v4i32 src1_lo = (v4i32)msa_paddlq_u16(zip1_lo);
            v4i32 src2_lo = (v4i32)msa_paddlq_u16(zip2_lo);
            v4i32 src0_hi = (v4i32)msa_paddlq_u16(zip0_hi);
            v4i32 src1_hi = (v4i32)msa_paddlq_u16(zip1_hi);
            v4i32 src2_hi = (v4i32)msa_paddlq_u16(zip2_hi);

            v4i32 v_X0 = msa_mlaq_s32(msa_mlaq_s32(msa_mulq_s32(src0_lo, v_c0), src1_lo, v_c1), src2_lo, v_c2);
            v4i32 v_Y0 = msa_mlaq_s32(msa_mlaq_s32(msa_mulq_s32(src0_lo, v_c3), src1_lo, v_c4), src2_lo, v_c5);
            v4i32 v_Z0 = msa_mlaq_s32(msa_mlaq_s32(msa_mulq_s32(src0_lo, v_c6), src1_lo, v_c7), src2_lo, v_c8);
            v4i32 v_X1 = msa_mlaq_s32(msa_mlaq_s32(msa_mulq_s32(src0_hi, v_c0), src1_hi, v_c1), src2_hi, v_c2);
            v4i32 v_Y1 = msa_mlaq_s32(msa_mlaq_s32(msa_mulq_s32(src0_hi, v_c3), src1_hi, v_c4), src2_hi, v_c5);
            v4i32 v_Z1 = msa_mlaq_s32(msa_mlaq_s32(msa_mulq_s32(src0_hi, v_c6), src1_hi, v_c7), src2_hi, v_c8);

            v8i16 dst0_lo = msa_pack_s32(msa_shrq_n_s32(msa_addq_s32(v_X0, v_delta), xyz_shift),
                                         msa_shrq_n_s32(msa_addq_s32(v_X1, v_delta), xyz_shift));
            v8i16 dst1_lo = msa_pack_s32(msa_shrq_n_s32(msa_addq_s32(v_Y0, v_delta), xyz_shift),
                                         msa_shrq_n_s32(msa_addq_s32(v_Y1, v_delta), xyz_shift));
            v8i16 dst2_lo = msa_pack_s32(msa_shrq_n_s32(msa_addq_s32(v_Z0, v_delta), xyz_shift),
                                         msa_shrq_n_s32(msa_addq_s32(v_Z1, v_delta), xyz_shift));

            v_zip = msa_paddlq_u8(data0_hi);
            ILVRL_H2_UH(v_zip, msa_dupq_n_u16(0), zip0_lo, zip0_hi);
            v_zip = msa_paddlq_u8(data1_hi);
            ILVRL_H2_UH(v_zip, msa_dupq_n_u16(0), zip1_lo, zip1_hi);
            v_zip = msa_paddlq_u8(data2_hi);
            ILVRL_H2_UH(v_zip, msa_dupq_n_u16(0), zip2_lo, zip2_hi);

            src0_lo = (v4i32)msa_paddlq_u16(zip0_lo);
            src1_lo = (v4i32)msa_paddlq_u16(zip1_lo);
            src2_lo = (v4i32)msa_paddlq_u16(zip2_lo);
            src0_hi = (v4i32)msa_paddlq_u16(zip0_hi);
            src1_hi = (v4i32)msa_paddlq_u16(zip1_hi);
            src2_hi = (v4i32)msa_paddlq_u16(zip2_hi);

            v_X0 = msa_mlaq_s32(msa_mlaq_s32(msa_mulq_s32(src0_lo, v_c0), src1_lo, v_c1), src2_lo, v_c2);
            v_Y0 = msa_mlaq_s32(msa_mlaq_s32(msa_mulq_s32(src0_lo, v_c3), src1_lo, v_c4), src2_lo, v_c5);
            v_Z0 = msa_mlaq_s32(msa_mlaq_s32(msa_mulq_s32(src0_lo, v_c6), src1_lo, v_c7), src2_lo, v_c8);
            v_X1 = msa_mlaq_s32(msa_mlaq_s32(msa_mulq_s32(src0_hi, v_c0), src1_hi, v_c1), src2_hi, v_c2);
            v_Y1 = msa_mlaq_s32(msa_mlaq_s32(msa_mulq_s32(src0_hi, v_c3), src1_hi, v_c4), src2_hi, v_c5);
            v_Z1 = msa_mlaq_s32(msa_mlaq_s32(msa_mulq_s32(src0_hi, v_c6), src1_hi, v_c7), src2_hi, v_c8);

            v8i16 dst0_hi = msa_pack_s32(msa_shrq_n_s32(msa_addq_s32(v_X0, v_delta), xyz_shift),
                                         msa_shrq_n_s32(msa_addq_s32(v_X1, v_delta), xyz_shift));
            v8i16 dst1_hi = msa_pack_s32(msa_shrq_n_s32(msa_addq_s32(v_Y0, v_delta), xyz_shift),
                                         msa_shrq_n_s32(msa_addq_s32(v_Y1, v_delta), xyz_shift));
            v8i16 dst2_hi = msa_pack_s32(msa_shrq_n_s32(msa_addq_s32(v_Z0, v_delta), xyz_shift),
                                         msa_shrq_n_s32(msa_addq_s32(v_Z1, v_delta), xyz_shift));

            v_data[0] = msa_qpacku_s16(dst0_lo, dst0_hi);
            v_data[1] = msa_qpacku_s16(dst1_lo, dst1_hi);
            v_data[2] = msa_qpacku_s16(dst2_lo, dst2_hi);
    ...
    int srccn, coeffs[9];
    v4i32 v_c0, v_c1, v_c2, v_c3, v_c4, v_c5, v_c6, v_c7, v_c8, v_delta;
};
...
struct RGB2XYZ_i<ushort>
{
    ...
    void operator()(const ushort * src, ushort * dst, int n) const
    {
        ...
        for( ; i <= n - 24; i += 24, src += scn * 8 )
        {
            v8u16 v_data[4], data0_lo, data0_hi, data1_lo, data1_hi, data2_lo, data2_hi;

            if( scn == 3 )
                msa_ld3q_u16(src, &v_data[0], &v_data[1], &v_data[2]);
            else
                msa_ld4q_u16(src, &v_data[0], &v_data[1], &v_data[2], &v_data[3]);

            ILVRL_H2_UH(v_data[0], msa_dupq_n_u16(0), data0_lo, data0_hi);
            ILVRL_H2_UH(v_data[1], msa_dupq_n_u16(0), data1_lo, data1_hi);
            ILVRL_H2_UH(v_data[2], msa_dupq_n_u16(0), data2_lo, data2_hi);

            v4i32 v_s0 = (v4i32)msa_paddlq_u16(data0_lo);
            v4i32 v_s1 = (v4i32)msa_paddlq_u16(data1_lo);
            v4i32 v_s2 = (v4i32)msa_paddlq_u16(data2_lo);

            v4i32 v_X0 = msa_mlaq_s32(msa_mlaq_s32(msa_mulq_s32(v_s0, v_c0), v_s1, v_c1), v_s2, v_c2);
            v4i32 v_Y0 = msa_mlaq_s32(msa_mlaq_s32(msa_mulq_s32(v_s0, v_c3), v_s1, v_c4), v_s2, v_c5);
            v4i32 v_Z0 = msa_mlaq_s32(msa_mlaq_s32(msa_mulq_s32(v_s0, v_c6), v_s1, v_c7), v_s2, v_c8);
            v_X0 = msa_shrq_n_s32(msa_addq_s32(v_X0, v_delta), xyz_shift);
            v_Y0 = msa_shrq_n_s32(msa_addq_s32(v_Y0, v_delta), xyz_shift);
            v_Z0 = msa_shrq_n_s32(msa_addq_s32(v_Z0, v_delta), xyz_shift);

            v_s0 = (v4i32)msa_paddlq_u16(data0_hi);
            v_s1 = (v4i32)msa_paddlq_u16(data1_hi);
            v_s2 = (v4i32)msa_paddlq_u16(data2_hi);

            v4i32 v_X1 = msa_mlaq_s32(msa_mlaq_s32(msa_mulq_s32(v_s0, v_c0), v_s1, v_c1), v_s2, v_c2);
            v4i32 v_Y1 = msa_mlaq_s32(msa_mlaq_s32(msa_mulq_s32(v_s0, v_c3), v_s1, v_c4), v_s2, v_c5);
            v4i32 v_Z1 = msa_mlaq_s32(msa_mlaq_s32(msa_mulq_s32(v_s0, v_c6), v_s1, v_c7), v_s2, v_c8);
            v_X1 = msa_shrq_n_s32(msa_addq_s32(v_X1, v_delta), xyz_shift);
            v_Y1 = msa_shrq_n_s32(msa_addq_s32(v_Y1, v_delta), xyz_shift);
            v_Z1 = msa_shrq_n_s32(msa_addq_s32(v_Z1, v_delta), xyz_shift);

            v_data[0] = msa_qpacku_s32(v_X0, v_X1);
            v_data[1] = msa_qpacku_s32(v_Y0, v_Y1);
            v_data[2] = msa_qpacku_s32(v_Z0, v_Z1);
...
struct XYZ2RGB_f<float>
{
    ...
    : dstcn(_dstcn), blueIdx(_blueIdx)
    {
        ...
        v_alpha = msa_dupq_n_f32(ColorChannel<float>::max());
    }
    ...
    void operator()(const float* src, float* dst, int n) const
    {
        ...
        for( ; i <= n - 12; i += 12, dst += 4 * dcn )
        {
            v4f32 v_src[3];

            msa_ld3q_f32(src + i, &v_src[0], &v_src[1], &v_src[2]);
            v4f32 v_dst0 = msa_mlaq_f32(msa_mlaq_f32(msa_mulq_f32(v_src[0], v_c0), v_src[1], v_c1), v_src[2], v_c2);
            v4f32 v_dst1 = msa_mlaq_f32(msa_mlaq_f32(msa_mulq_f32(v_src[0], v_c3), v_src[1], v_c4), v_src[2], v_c5);
            v4f32 v_dst2 = msa_mlaq_f32(msa_mlaq_f32(msa_mulq_f32(v_src[0], v_c6), v_src[1], v_c7), v_src[2], v_c8);

            if( dcn == 4 )
                msa_st4q_f32(dst, v_dst0, v_dst1, v_dst2, v_alpha);
            else
                msa_st3q_f32(dst, v_dst0, v_dst1, v_dst2);
        }
    ...
    int dstcn, blueIdx;
    float coeffs[9];
    v4f32 v_c0, v_c1, v_c2, v_c3, v_c4, v_c5, v_c6, v_c7, v_c8, v_alpha;
};
...
struct XYZ2RGB_i<uchar>
{
    ...
    : dstcn(_dstcn), blueIdx(_blueIdx)
    {
        ...
        v_c8 = msa_dupq_n_s32(coeffs[8]);
        v_delta = msa_dupq_n_s32(1 << (xyz_shift - 1));
        v_alpha = msa_dupq_n_u8(ColorChannel<uchar>::max());
    }
    ...
    void operator()(const uchar* src, uchar* dst, int n) const
    {
        ...
        {
            v16u8 v_data[3], data0_lo, data0_hi, data1_lo, data1_hi, data2_lo, data2_hi;
            v8u16 zip0_lo, zip0_hi, zip1_lo, zip1_hi, zip2_lo, zip2_hi;

            msa_ld3q_u8(src + i, &v_data[0], &v_data[1], &v_data[2]);
            ILVRL_B2_UB(v_data[0], msa_dupq_n_u8(0), data0_lo, data0_hi);
            ILVRL_B2_UB(v_data[1], msa_dupq_n_u8(0), data1_lo, data1_hi);
            ILVRL_B2_UB(v_data[2], msa_dupq_n_u8(0), data2_lo, data2_hi);
            ...
            if( dcn == 3 )
                msa_st3q_u8(dst, v_data[0], v_data[1], v_data[2]);
            else
                msa_st4q_u8(dst, v_data[0], v_data[1], v_data[2], v_alpha);
        }
...
struct XYZ2RGB_i<ushort>
{
    ...
    : dstcn(_dstcn), blueIdx(_blueIdx)
    {
        ...
        v_c8 = msa_dupq_n_s32(coeffs[8]);
        v_delta = msa_dupq_n_s32(1 << (xyz_shift - 1));
        v_alpha = msa_dupq_n_u16(ColorChannel<ushort>::max());
    }
    ...
    void operator()(const ushort* src, ushort* dst, int n) const
    {
        ...
        for( ; i <= n - 24; i += 24, dst += dcn * 8 )
        {
            v8u16 v_data[3], data0_lo, data0_hi, data1_lo, data1_hi, data2_lo, data2_hi;

            msa_ld3q_u16(src + i, &v_data[0], &v_data[1], &v_data[2]);
            ILVRL_H2_UH(v_data[0], msa_dupq_n_u16(0), data0_lo, data0_hi);
            ILVRL_H2_UH(v_data[1], msa_dupq_n_u16(0), data1_lo, data1_hi);
            ILVRL_H2_UH(v_data[2], msa_dupq_n_u16(0), data2_lo, data2_hi);
            ...
            if( dcn == 3 )
                msa_st3q_u16(dst, v_data[0], v_data[1], v_data[2]);
            else
                msa_st4q_u16(dst, v_data[0], v_data[1], v_data[2], v_alpha);
        }
...
struct Lab2RGBfloat
{
    ...
    void operator()(const float* src, float* dst, int n) const
    {
        ...
        for( ; i <= n - 12; i += 12, dst += 4 * dcn )
        {
            ...
            v4f32 v_y0 = msa_divq_f32(v_src[0], msa_dupq_n_f32(903.3f));
            v4f32 v_fy0 = msa_mlaq_f32(msa_dupq_n_f32(16.0f/116.0f), v_y0, msa_dupq_n_f32(7.787f));
            v4f32 v_fy1 = msa_divq_f32(msa_addq_f32(v_src[0], msa_dupq_n_f32(16.0f)), msa_dupq_n_f32(116.0f));
            v4f32 v_y1 = msa_mulq_f32(msa_mulq_f32(v_fy1, v_fy1), v_fy1);

            v4u32 v_cmp = msa_cleq_f32(v_src[0], msa_dupq_n_f32(lThresh));
            v_fy0 = (v4f32)msa_andq_u32(v_cmp, (v4u32)v_fy0);
            v_y0 = (v4f32)msa_andq_u32(v_cmp, (v4u32)v_y0);
            v_cmp = msa_cgtq_f32(v_src[0], msa_dupq_n_f32(lThresh));
            v_fy1 = (v4f32)msa_andq_u32(v_cmp, (v4u32)v_fy1);
            v_y1 = (v4f32)msa_andq_u32(v_cmp, (v4u32)v_y1);
            v4f32 v_fy = (v4f32)msa_orrq_u32((v4u32)v_fy0, (v4u32)v_fy1);
            v4f32 v_y = (v4f32)msa_orrq_u32((v4u32)v_y0, (v4u32)v_y1);

            v4f32 v_fxz0 = msa_mlaq_f32(v_fy, v_src[1], msa_dupq_n_f32(0.002f));
            v4f32 v_fxz1 = msa_subq_f32(v_fy, msa_mulq_f32(v_src[2], msa_dupq_n_f32(0.005f)));
            v4f32 v_fxz00 = msa_divq_f32(msa_subq_f32(v_fxz0, msa_dupq_n_f32(16.0f/116.0f)), msa_dupq_n_f32(7.787f));
            v4f32 v_fxz10 = msa_divq_f32(msa_subq_f32(v_fxz1, msa_dupq_n_f32(16.0f/116.0f)), msa_dupq_n_f32(7.787f));
            v4f32 v_fxz01 = msa_mulq_f32(msa_mulq_f32(v_fxz0, v_fxz0), v_fxz0);
            v4f32 v_fxz11 = msa_mulq_f32(msa_mulq_f32(v_fxz1, v_fxz1), v_fxz1);

            v_cmp = msa_cleq_f32(v_fxz0, msa_dupq_n_f32(fThresh));
            v_fxz00 = (v4f32)msa_andq_u32(v_cmp, (v4u32)v_fxz00);
            v_cmp = msa_cgtq_f32(v_fxz0, msa_dupq_n_f32(fThresh));
            v_fxz01 = (v4f32)msa_andq_u32(v_cmp, (v4u32)v_fxz01);
            v4f32 v_x = (v4f32)msa_orrq_u32((v4u32)v_fxz00, (v4u32)v_fxz01);

            v_cmp = msa_cleq_f32(v_fxz1, msa_dupq_n_f32(fThresh));
            v_fxz10 = (v4f32)msa_andq_u32(v_cmp, (v4u32)v_fxz10);
            v_cmp = msa_cgtq_f32(v_fxz1, msa_dupq_n_f32(fThresh));
            v_fxz11 = (v4f32)msa_andq_u32(v_cmp, (v4u32)v_fxz11);
            v4f32 v_z = (v4f32)msa_orrq_u32((v4u32)v_fxz10, (v4u32)v_fxz11);

            v4f32 v_ro = msa_mlaq_f32(msa_mlaq_f32(msa_mulq_f32(v_x, v_c0), v_y, v_c1), v_z, v_c2);
            v4f32 v_go = msa_mlaq_f32(msa_mlaq_f32(msa_mulq_f32(v_x, v_c3), v_y, v_c4), v_z, v_c5);
            v4f32 v_bo = msa_mlaq_f32(msa_mlaq_f32(msa_mulq_f32(v_x, v_c6), v_y, v_c7), v_z, v_c8);

            v_ro = msa_minq_f32(msa_maxq_f32(v_ro, msa_dupq_n_f32(0.0f)), msa_dupq_n_f32(1.0f));
            v_go = msa_minq_f32(msa_maxq_f32(v_go, msa_dupq_n_f32(0.0f)), msa_dupq_n_f32(1.0f));
            v_bo = msa_minq_f32(msa_maxq_f32(v_bo, msa_dupq_n_f32(0.0f)), msa_dupq_n_f32(1.0f));

            if( gammaTab )
            {
                v_ro = msa_mulq_f32(v_ro, msa_dupq_n_f32(gscale));
                v_go = msa_mulq_f32(v_go, msa_dupq_n_f32(gscale));
                v_bo = msa_mulq_f32(v_bo, msa_dupq_n_f32(gscale));
                splineInterpolate(v_ro, gammaTab, GAMMA_TAB_SIZE);
                splineInterpolate(v_go, gammaTab, GAMMA_TAB_SIZE);
                splineInterpolate(v_bo, gammaTab, GAMMA_TAB_SIZE);
            }

            if( dcn == 4 )
                msa_st4q_f32(dst, v_ro, v_go, v_bo, v_alpha);
            else
                msa_st3q_f32(dst, v_ro, v_go, v_bo);
        }
        #endif
...
struct Lab2RGB_b
{
    ...
    : fcvt(3, _blueIdx, _coeffs, _whitept, _srgb ), icvt(_dstcn, _blueIdx, _coeffs, _whitept, _srgb), dstcn(_dstcn)
    {
        ...
        #elif CV_MSA
        v_scale_inv = msa_dupq_n_f32(100.f/255.f);
        v_scale = msa_dupq_n_f32(255.f);
        v_alpha = msa_dupq_n_u8(ColorChannel<uchar>::max());
        v_128 = msa_dupq_n_f32(128.0f);
        #elif CV_SSE2
    ...
    void operator()(const uchar* src, uchar* dst, int n) const
    {
        ...
        for(; i < n; i += BLOCK_SIZE, src += BLOCK_SIZE*3 )
        {
            ...
            for( ; j <= (dn - 16) * 3; j += 48 )
            {
                ...
                v4f32 v_dst1 = msa_subq_f32(msa_cvtfintq_f32_u32(msa_paddlq_u16(zip1_lo)), v_128);
                v4f32 v_dst2 = msa_subq_f32(msa_cvtfintq_f32_u32(msa_paddlq_u16(zip2_lo)), v_128);
                msa_st3q_f32(buf + j, v_dst0, v_dst1, v_dst2);

                v_dst0 = msa_mulq_f32(msa_cvtfintq_f32_u32(msa_paddlq_u16(zip0_hi)), v_scale_inv);
                v_dst1 = msa_subq_f32(msa_cvtfintq_f32_u32(msa_paddlq_u16(zip1_hi)), v_128);
                v_dst2 = msa_subq_f32(msa_cvtfintq_f32_u32(msa_paddlq_u16(zip2_hi)), v_128);
                ...
                v_dst1 = msa_subq_f32(msa_cvtfintq_f32_u32(msa_paddlq_u16(zip1_lo)), v_128);
                v_dst2 = msa_subq_f32(msa_cvtfintq_f32_u32(msa_paddlq_u16(zip2_lo)), v_128);
            ...
            if( dcn == 3 )
            {
                ...
                {
                    v4f32 v_src0, v_src1, v_src2, v_src3;

                    v_src0 = msa_ld1q_f32(buf + j);
                    v_src1 = msa_ld1q_f32(buf + j + 4);
                    v_src2 = msa_ld1q_f32(buf + j + 8);
                    v_src3 = msa_ld1q_f32(buf + j + 12);

                    v8u16 dst_lo = msa_qpack_u32(msa_cvttintq_u32_f32(msa_mulq_f32(v_src0, v_scale)),
                                                 msa_cvttintq_u32_f32(msa_mulq_f32(v_src1, v_scale)));
                    v8u16 dst_hi = msa_qpack_u32(msa_cvttintq_u32_f32(msa_mulq_f32(v_src2, v_scale)),
                                                 msa_cvttintq_u32_f32(msa_mulq_f32(v_src3, v_scale)));
                    v16u8 v_dst = msa_qpack_u16(dst_lo, dst_hi);
            ...
            {
                for( ; j <= (dn - 16) * 3; j += 48, dst += 64 )
                {
                    v4f32 v_src0[3], v_src1[3], v_src2[3], v_src3[3];

                    msa_ld3q_f32(buf + j, &v_src0[0], &v_src0[1], &v_src0[2]);
                    msa_ld3q_f32(buf + j + 12, &v_src1[0], &v_src1[1], &v_src1[2]);
                    msa_ld3q_f32(buf + j + 24, &v_src2[0], &v_src2[1], &v_src2[2]);
                    msa_ld3q_f32(buf + j + 36, &v_src3[0], &v_src3[1], &v_src3[2]);

                    v8u16 dst_lo = msa_qpack_u32(msa_cvttintq_u32_f32(msa_mulq_f32(v_src0[0], v_scale)),
                                                 msa_cvttintq_u32_f32(msa_mulq_f32(v_src1[0], v_scale)));
                    v8u16 dst_hi = msa_qpack_u32(msa_cvttintq_u32_f32(msa_mulq_f32(v_src2[0], v_scale)),
                                                 msa_cvttintq_u32_f32(msa_mulq_f32(v_src3[0], v_scale)));
                    v16u8 v_dst0 = msa_qpack_u16(dst_lo, dst_hi);

                    dst_lo = msa_qpack_u32(msa_cvttintq_u32_f32(msa_mulq_f32(v_src0[1], v_scale)),
                                           msa_cvttintq_u32_f32(msa_mulq_f32(v_src1[1], v_scale)));
                    dst_hi = msa_qpack_u32(msa_cvttintq_u32_f32(msa_mulq_f32(v_src2[1], v_scale)),
                                           msa_cvttintq_u32_f32(msa_mulq_f32(v_src3[1], v_scale)));
                    v16u8 v_dst1 = msa_qpack_u16(dst_lo, dst_hi);

                    dst_lo = msa_qpack_u32(msa_cvttintq_u32_f32(msa_mulq_f32(v_src0[2], v_scale)),
                                           msa_cvttintq_u32_f32(msa_mulq_f32(v_src1[2], v_scale)));
                    dst_hi = msa_qpack_u32(msa_cvttintq_u32_f32(msa_mulq_f32(v_src2[2], v_scale)),
                                           msa_cvttintq_u32_f32(msa_mulq_f32(v_src3[2], v_scale)));
                    v16u8 v_dst2 = msa_qpack_u16(dst_lo, dst_hi);
    ...
    uint8x8_t v_alpha;
    #elif CV_MSA
    v4f32 v_scale, v_scale_inv, v_128;
    v16u8 v_alpha;
    #elif CV_SSE2
    __m128 v_scale;
    __m128 v_alpha;
...
struct RGB2Luvfloat
{
    ...
    #elif CV_MSA
    void process(v4f32& v_src0, v4f32& v_src1, v4f32& v_src2) const
    {
        v4f32 v_x = msa_mlaq_f32(msa_mlaq_f32(msa_mulq_f32(v_src0, msa_dupq_n_f32(coeffs[0])), v_src1, msa_dupq_n_f32(coeffs[1])), v_src2, msa_dupq_n_f32(coeffs[2]));
        v4f32 v_y = msa_mlaq_f32(msa_mlaq_f32(msa_mulq_f32(v_src0, msa_dupq_n_f32(coeffs[3])), v_src1, msa_dupq_n_f32(coeffs[4])), v_src2, msa_dupq_n_f32(coeffs[5]));
        v4f32 v_z = msa_mlaq_f32(msa_mlaq_f32(msa_mulq_f32(v_src0, msa_dupq_n_f32(coeffs[6])), v_src1, msa_dupq_n_f32(coeffs[7])), v_src2, msa_dupq_n_f32(coeffs[8]));

        v_src0 = msa_mulq_f32(v_y, msa_dupq_n_f32(LabCbrtTabScale));
        splineInterpolate(v_src0, LabCbrtTab, LAB_CBRT_TAB_SIZE);

        v_src0 = msa_mlaq_f32(msa_dupq_n_f32(-16.f), v_src0, msa_dupq_n_f32(116.f));

        v4f32 v_div = msa_maxq_f32(msa_mlaq_f32(msa_mlaq_f32(v_x, msa_dupq_n_f32(15.f), v_y), msa_dupq_n_f32(3.f), v_z), msa_dupq_n_f32(FLT_EPSILON));
        v4f32 v_d = msa_divq_f32(msa_dupq_n_f32(52.f), v_div);

        v_src1 = msa_mulq_f32(v_src0, msa_mlaq_f32(msa_dupq_n_f32(-un), v_x, v_d));
        v_src2 = msa_mulq_f32(v_src0, msa_mlaq_f32(msa_dupq_n_f32(-vn), msa_mulq_f32(msa_dupq_n_f32(2.25f), v_y), v_d));
    }
    #elif CV_SSE2
    ...
    void operator()(const float* src, float* dst, int n) const
    {
        ...
        for( ; i <= n - 12; i += 12, src += scn * 4 )
        {
            ...
            if( scn == 3 )
                msa_ld3q_f32(src, &v_data[0], &v_data[1], &v_data[2]);
            else
                msa_ld4q_f32(src, &v_data[0], &v_data[1], &v_data[2], &v_data[3]);

            v_data[0] = msa_minq_f32(msa_maxq_f32(v_data[0], msa_dupq_n_f32(0.0f)), msa_dupq_n_f32(1.0f));
            v_data[1] = msa_minq_f32(msa_maxq_f32(v_data[1], msa_dupq_n_f32(0.0f)), msa_dupq_n_f32(1.0f));
            v_data[2] = msa_minq_f32(msa_maxq_f32(v_data[2], msa_dupq_n_f32(0.0f)), msa_dupq_n_f32(1.0f));

            if( gammaTab )
            {
                v_data[0] = msa_mulq_f32(v_data[0], msa_dupq_n_f32(gscale));
                v_data[1] = msa_mulq_f32(v_data[1], msa_dupq_n_f32(gscale));
                v_data[2] = msa_mulq_f32(v_data[2], msa_dupq_n_f32(gscale));
                splineInterpolate(v_data[0], gammaTab, GAMMA_TAB_SIZE);
                splineInterpolate(v_data[1], gammaTab, GAMMA_TAB_SIZE);
                splineInterpolate(v_data[2], gammaTab, GAMMA_TAB_SIZE);
            }

            process(v_data[0], v_data[1], v_data[2]);

            msa_st3q_f32(dst + i, v_data[0], v_data[1], v_data[2]);
        }
        #elif CV_SSE2
        if (haveSIMD)
        {
...
struct Luv2RGBfloat
{
    ...
    void operator()(const float* src, float* dst, int n) const
    {
        ...
        for( ; i <= n - 12; i += 12, dst += 4 * dcn )
        {
            ...
            v4f32 v_y0 = msa_divq_f32(v_src[0], msa_dupq_n_f32(903.3f));
            v4f32 v_y1 = msa_mlaq_f32(msa_dupq_n_f32(16.0f/116.0f), v_src[0], msa_dupq_n_f32(1.0f/116.0f));
            v_y1 = msa_mulq_f32(msa_mulq_f32(v_y1, v_y1), v_y1);

            v4u32 v_cmp = msa_cltq_f32(v_src[0], msa_dupq_n_f32(8.0f));
            v_y0 = (v4f32)msa_andq_u32(v_cmp, (v4u32)v_y0);
            v_cmp = msa_cgeq_f32(v_src[0], msa_dupq_n_f32(8.0f));
            v_y1 = (v4f32)msa_andq_u32(v_cmp, (v4u32)v_y1);
            v4f32 v_y = (v4f32)msa_orrq_u32((v4u32)v_y0, (v4u32)v_y1);

            v4f32 v_up = msa_mulq_f32(msa_dupq_n_f32(3.0f), msa_mlaq_f32(v_src[1], v_src[0], msa_dupq_n_f32(un)));
            v4f32 v_vp = msa_divq_f32(msa_dupq_n_f32(0.25f), msa_mlaq_f32(v_src[2], v_src[0], msa_dupq_n_f32(vn)));
            v_vp = msa_minq_f32(msa_maxq_f32(v_vp, msa_dupq_n_f32(-0.25f)), msa_dupq_n_f32(0.25f));
            v4f32 v_x = msa_mulq_f32(msa_mulq_f32(msa_dupq_n_f32(3.0f), v_up), v_vp);
            v4f32 v_z = msa_mlaq_f32(msa_dupq_n_f32(-5.0f), v_vp, msa_subq_f32(msa_mulq_f32(v_src[0], msa_dupq_n_f32(12.0f*13.0f)), v_up));

            v4f32 v_r = msa_mulq_f32(msa_mlaq_f32(msa_mlaq_f32(v_c1, v_x, v_c0), v_z, v_c2), v_y);
            v4f32 v_g = msa_mulq_f32(msa_mlaq_f32(msa_mlaq_f32(v_c4, v_x, v_c3), v_z, v_c5), v_y);
            v4f32 v_b = msa_mulq_f32(msa_mlaq_f32(msa_mlaq_f32(v_c7, v_x, v_c6), v_z, v_c8), v_y);

            v_r = msa_minq_f32(msa_maxq_f32(v_r, msa_dupq_n_f32(0.0f)), msa_dupq_n_f32(1.0f));
            v_g = msa_minq_f32(msa_maxq_f32(v_g, msa_dupq_n_f32(0.0f)), msa_dupq_n_f32(1.0f));
            v_b = msa_minq_f32(msa_maxq_f32(v_b, msa_dupq_n_f32(0.0f)), msa_dupq_n_f32(1.0f));

            if( gammaTab )
            {
                v_r = msa_mulq_f32(v_r, msa_dupq_n_f32(gscale));
                v_g = msa_mulq_f32(v_g, msa_dupq_n_f32(gscale));
                v_b = msa_mulq_f32(v_b, msa_dupq_n_f32(gscale));
                splineInterpolate(v_r, gammaTab, GAMMA_TAB_SIZE);
                splineInterpolate(v_g, gammaTab, GAMMA_TAB_SIZE);
                splineInterpolate(v_b, gammaTab, GAMMA_TAB_SIZE);
            }

            if( dcn == 4 )
                msa_st4q_f32(dst, v_r, v_g, v_b, v_alpha);
            else
                msa_st3q_f32(dst, v_r, v_g, v_b);
        }
        #endif
...
struct RGB2Luv_b
{
      ...
      icvt(_srccn, blueIdx, _coeffs, _whitept, _srgb)
    {
        ...
        v_alpha = vdup_n_u8(ColorChannel<uchar>::max());
        #elif CV_MSA
        v_scale_inv = msa_dupq_n_f32(softfloat::one()/f255);
        v_scale = msa_dupq_n_f32(f255/softfloat(100));
        v_coeff1 = msa_dupq_n_f32(f255/uRange);
        v_coeff2 = msa_dupq_n_f32(-uLow*f255/uRange);
        v_coeff3 = msa_dupq_n_f32(f255/vRange);
        v_coeff4 = msa_dupq_n_f32(-vLow*f255/vRange);
        #elif CV_SSE2
        v_zero = _mm_setzero_si128();
    ...
    void operator()(const uchar* src, uchar* dst, int n) const
    {
        ...
        for( i = 0; i < n; i += BLOCK_SIZE, dst += BLOCK_SIZE*3 )
        {
            ...
            if( scn == 3 )
            {
                ...
                {
                    v16u8 v_src, src_lo, src_hi;
                    v8u16 zip_lo, zip_hi;

                    v_src = msa_ld1q_u8(src);
                    ILVRL_B2_UB(v_src, msa_dupq_n_u8(0), src_lo, src_hi);

                    v8u16 v_zip = msa_paddlq_u8(src_lo);
                    ILVRL_H2_UH(v_zip, msa_dupq_n_u16(0), zip_lo, zip_hi);
                    msa_st1q_f32(buf + j, msa_mulq_f32(msa_cvtfintq_f32_u32(msa_paddlq_u16(zip_lo)), v_scale_inv));
                    msa_st1q_f32(buf + j + 4, msa_mulq_f32(msa_cvtfintq_f32_u32(msa_paddlq_u16(zip_hi)), v_scale_inv));

                    v_zip = msa_paddlq_u8(src_hi);
                    ILVRL_H2_UH(v_zip, msa_dupq_n_u16(0), zip_lo, zip_hi);
                    msa_st1q_f32(buf + j + 8, msa_mulq_f32(msa_cvtfintq_f32_u32(msa_paddlq_u16(zip_lo)), v_scale_inv));
                    msa_st1q_f32(buf + j + 12, msa_mulq_f32(msa_cvtfintq_f32_u32(msa_paddlq_u16(zip_hi)), v_scale_inv));
                }
            ...
            for( ; j <= (dn - 16) * 3; j += 48 )
            {
                ...
                dst_lo = msa_qpack_u32(msa_cvttintq_u32_f32(msa_mlaq_f32(v_coeff2, v_src0[1], v_coeff1)),
                                       msa_cvttintq_u32_f32(msa_mlaq_f32(v_coeff2, v_src1[1], v_coeff1)));
                dst_hi = msa_qpack_u32(msa_cvttintq_u32_f32(msa_mlaq_f32(v_coeff2, v_src2[1], v_coeff1)),
                                       msa_cvttintq_u32_f32(msa_mlaq_f32(v_coeff2, v_src3[1], v_coeff1)));
                v16u8 v_dst1 = msa_qpack_u16(dst_lo, dst_hi);

                dst_lo = msa_qpack_u32(msa_cvttintq_u32_f32(msa_mlaq_f32(v_coeff4, v_src0[2], v_coeff3)),
                                       msa_cvttintq_u32_f32(msa_mlaq_f32(v_coeff4, v_src1[2], v_coeff3)));
                dst_hi = msa_qpack_u32(msa_cvttintq_u32_f32(msa_mlaq_f32(v_coeff4, v_src2[2], v_coeff3)),
                                       msa_cvttintq_u32_f32(msa_mlaq_f32(v_coeff4, v_src3[2], v_coeff3)));
                v16u8 v_dst2 = msa_qpack_u16(dst_lo, dst_hi);
    ...
    uint8x8_t v_alpha;
    #elif CV_MSA
    v4f32 v_scale, v_scale_inv, v_coeff1, v_coeff2, v_coeff3, v_coeff4;
    #elif CV_SSE2
    __m128 v_scale_inv;
    __m128i v_zero;
    bool haveSIMD;
