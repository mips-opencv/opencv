...
#define msa_st1_lane_s8(__a, __b, __c) (*((int8_t *)(__b)) = __b[__c])
#define msa_st1_lane_s16(__a, __b, __c) (*((int16_t*)(__b)) = __b[__c])
#define msa_st1_lane_s32(__a, __b, __c) (*((int32_t*)(__b)) = __b[__c])
#define msa_st1_lane_f32(__a, __b, __c) (*((float*)(__b)) = __b[__c])
#define msa_st1_lane_u8(__a, __b, __c) (*((uint8_t *)(__b)) = __b[__c])
#define msa_st1_lane_u16(__a, __b, __c) (*((uint16_t *)(__b)) = __b[__c])
#define msa_st1_lane_u32(__a, __b, __c) (*((uint32_t *)(__b)) = __b[__c])
#define msa_st1_lane_s64(__a, __b, __c) (*((int64_t *)(__b)) = __b[__c])
#define msa_st1_lane_u64(__a, __b, __c) (*((uint64_t *)(__b)) = __b[__c])
#define msa_st1q_lane_s8(__a, __b, __c) (*((int8_t *)(__b)) = __msa_copy_s_b(__b,__c))
#define msa_st1q_lane_s16(__a, __b, __c) (*((int16_t *)(__b)) = __msa_copy_s_h(__b,__c))
#define msa_st1q_lane_s32(__a, __b, __c) (*((int32_t *)(__b)) = __msa_copy_s_w(__b,__c))
#define msa_st1q_lane_f32(__a, __b, __c) (*((float *)(__b)) = (float)__msa_copy_s_w((v4i32)(__b),__c))
#define msa_st1q_lane_u8(__a, __b, __c) (*((uint8_t)(__b)) = __msa_copy_u_b(__b,__c))
#define msa_st1q_lane_u16(__a, __b, __c) (*((uint16_t *)(__b)) = __msa_copy_u_h(__b,__c))
#define msa_st1q_lane_u32 (__a, __b, __c) (*((uint32_t *)(_a))= __msa_copy_u_w(__b,__c))
#define msa_st1q_lane_s64 (__a, __b, __c) (*((int64_t *)(_a)) = __msa_copy_s_d(__b,__c))
